...
/obj/item/organ/internal/eyes/skrell/generate_body_overlay(mob/living/carbon/human/parent)
	...
	var/mutable_appearance/eye_left = mutable_appearance('icons/mob/species/skrell/skrell_eyes.dmi', "[eye_icon_state]_l", -BODY_LAYER)
	var/mutable_appearance/eye_right = mutable_appearance('icons/mob/species/skrell/skrell_eyes.dmi', "[eye_icon_state]_r", -BODY_LAYER)
